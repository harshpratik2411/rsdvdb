...
function NavbarLinks() {
  return (
    <ul className='flex gap-6 text-white font-bold text-center py-4 lg:flex-row sm:flex-col lg:relative sm:absloute sm:top-[120%]left-[50%] -translate-x-[50%] lg:text-md sm:text-xl sm:bg-cyan/30 backdrop:blur-lg lg:bg-black sm:w-full '>
